...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $storedUser = getSetting('admin_username', ADMIN_USERNAME);
    $storedPass = getSetting('admin_password', ADMIN_PASSWORD);
...
<body class="flex items-center justify-center min-h-screen">
    <div class="bg-[#fdfbf7] p-8 rounded-lg shadow-2xl classic-border w-full max-w-md text-center">
        ...
        <form method="POST" class="space-y-4">
            ...
            <button type="submit"
                class="mt-8 px-10 py-2 border border-[#4a3728] text-[#4a3728] hover:bg-[#4a3728] hover:text-white transition duration-300 font-bold uppercase tracking-widest">
                Masuk
            </button>
        </form>

        <div style="margin-top:20px;padding-top:16px;border-top:1px solid #e0ddd5;">
            <a href="../index.php" style="font-size:0.82rem;color:#6f816a;text-decoration:none;">
